...
public class TrustAllCertsSSLConnectionSocketFactory extends SSLConnectionSocketFactory {
	...
	public static TrustAllCertsSSLConnectionSocketFactory getInstance() {
		TrustAllCertsSSLConnectionSocketFactory socketFactory = null;
		try {
			SSLContext sc = SSLContext.getInstance("SSL"); 
			sc.init(null, trustAllCerts, new java.security.SecureRandom()); 
			socketFactory = new TrustAllCertsSSLConnectionSocketFactory(sc);
		} catch (GeneralSecurityException e) {
		} 
		return socketFactory;
	}
	
	public TrustAllCertsSSLConnectionSocketFactory(SSLContext sc) {
		super(sc,hostnameVerifier);
