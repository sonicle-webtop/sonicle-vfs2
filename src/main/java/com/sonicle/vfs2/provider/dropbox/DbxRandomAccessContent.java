...
public class DbxRandomAccessContent extends AbstractRandomAccessStreamContent {
	...
	protected InputStream dbxInputStream;
	...
	protected DataInputStream getDataInputStream() throws IOException {
		...
		dbxInputStream = fileObject.getInputStream();
		for(int i = 0; (long)i < filePointer; i++) dbxInputStream.read();
		
		dataInputStream = new DataInputStream(new FilterInputStream(dbxInputStream) {
